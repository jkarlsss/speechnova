...
export type VoiceItem = inferRouterOutputs<
  AppRouter
>["voices"]["getAll"]["custom"][number];
...
export function VoiceCard({ voice }: VoiceCardProps) {
  ...
  const { isPlaying, togglePlay, isLoading } = useAudioPlayback(audioSrc);
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem asChild>
              <Link href={`/text-to-speech?voiceId=${voice.id}`}>
                ...
                <span className="font-medium text-xs">Use voice</span>
              </Link>
            </DropdownMenuItem>
            {voice.variant === "CUSTOM" && (
              ...
              >
                ...
                <span className="font-medium text-xs">Delete voice</span>
              </DropdownMenuItem>
            )}
          </DropdownMenuContent>
        </DropdownMenu>
